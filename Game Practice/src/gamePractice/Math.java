...
//	
	...
	public int addition(int playerNum, int monsterNum, int correctAnswer){
		correctAnswer =  playerNum + monsterNum;
		return correctAnswer;
	} // addition for game
	
	public int subtraction(int playerNum, int monsterNum, int correctAnswer){
		correctAnswer =  playerNum - monsterNum;
		return correctAnswer;
	} // addition for game
	
	public int multiplication(int playerNum, int monsterNum, int correctAnswer){
		correctAnswer =  playerNum * monsterNum;
		return correctAnswer;
	} // addition for game
